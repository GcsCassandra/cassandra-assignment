...
class ValidationFT {
    ...
    void satellite_reads_scan_location() throws Exception {
        String getUrl = "http://localhost:8080/scan/location/25N,71W";
        String postUrl = "http://localhost:8080/scan/location";
    ...
    void satellite_sends_scan_results() throws Exception {
        String getUrl = "http://localhost:8080/scan/result/location/25N,71W/day/2025-08-17"; 
        String postUrl = "http://localhost:8080/scan/result";
